        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(default="#222222", max_length=7),
                ),
                ("color_body_text", models.CharField(default="#ffffff", max_length=7)),
                (
                    "color_nav_background",
                    models.CharField(default="#111111", max_length=7),
                ),
                (
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="_joueur_amis_+", to="jeux.Joueur"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "jeu_concerne",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="jeux.Jeu"
                    ),
                ),
                (
                    "joueur_concerne",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="jeux.Joueur"
                    ),
                ),
            ],
        ),
